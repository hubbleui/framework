...
Because styling and JavaScript functionality of tabs are split with `.js-` classes, you can use other Hubble components to create your own styled tabs:

Here is an example Hubble's `.btn` for the navigation:
