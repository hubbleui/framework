...
*   [Button spinners](#button-spinners)
...
<div class="code-content-example">
    <div class="container-fuid bg-primary pad-20">
        ...
        <button class="btn btn-on-primary with-spinner active" type="button"><svg viewBox="0 0 64 64" class="loading-spinner"><circle class="path" cx="32" cy="32" r="30" fill="none" stroke-width="4"></circle></svg> Spin! </button>
    </div>
</div>
...
<button class="btn btn-on-primary btn-outline" type="button">.btn-outline</button>
<button class="btn btn-on-primary btn-pure" type="button">.btn-pure</button>
<button class="btn btn-on-primary with-spinner active" type="button"><svg>...</svg></button>
```
...
<div class="code-content-example">
    <div class="container-fuid">
        <button class="btn with-spinner active" type="button"> <svg viewBox="0 0 64 64" class="loading-spinner"><circle class="path" cx="32" cy="32" r="30" fill="none" stroke-width="4"></circle></svg> Spin! </button>
    </div>
</div>

```html
<button class="btn with-spinner active" type="button">
    <svg>...</svg>Spin!
</button>
```
