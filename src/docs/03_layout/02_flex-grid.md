...
Because Hubble is mobile first, all screen-size specific grid classes will be applied to the breakpoint and above. For example `.col-md-6` will apply to medium screen sizes and above, but not below. The grid system includes all the necessary screen-size specific classes.
...
{
    --hb-flex-wrap: wrap;
    --hb-flex-direction: row;
    --hb-flex-col-gaps: 0px;
    --hb-flex-row-gaps: 0px;
}
