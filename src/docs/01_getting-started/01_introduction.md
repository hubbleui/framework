...
*   [Welcome](#welcome)
*   [How does it work?](#how-to-read-this-documentation)
...
Hubble is a modular `CSS` and `JavaScript` front-end framework built with `Sass` and vanilla `JavaScript`. Hubble is designed so that you can use it as a starting point for any sized project from a tiny landing page to a giant web app.
...
<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/gh/hubbleui/framework@0.1.0/dist/css/hubble.bundle.min.css" rel="stylesheet" crossorigin="anonymous">
  </head>
  <body>
    <h1>Hello, world!</h1>
    <script src="https://cdn.jsdelivr.net/gh/hubbleui/framework@0.1.0/dist/js/hubble.bundle.min.js" crossorigin="anonymous"></script>
  </body>
</html>
```
